...
<body translate="no">
    ...
    <div class="registration-form">
        ...
        <form>
            ...
            <div class="input-section numUnidades-section folded">
                <input class="numUnidades" type="number" id="numUnidades" placeholder="NUMERO DE UNIDADES" min="1" max="3">
    ...
    <script id="rendered-js">
        ...
        $('#descargarTabla').click(function(event) {
            ...
            xhr.onload = function() {
                if (xhr.status === 200) {
                    ...
                    a.href = url;
                    a.download = 'PlanEstudiosGenerado.docx';
                    document.body.appendChild(a);
                    a.click();
                    window.URL.revokeObjectURL(url);
                    document.body.removeChild(a);
                } else {
                    console.log("Error al enviar los datos: ", xhr.statusText);
                }
            };
            ...
            xhr.send(JSON.stringify(informacionCapturada));
        });
    </script>
